...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Até mais, tchauzinho!';
...
const FallbackIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Desculpe, não tenho esse pedido indexado, tente saber informações...';
...
const IntentReflectorHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `Você chamou a intent ${intentName}!`;
